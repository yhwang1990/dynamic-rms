...
public class ME_n_R {
	...
	private static void runMinErrorRMS(String dataPath, String tuplePath, String timePath) throws IOException {
		...
		int k = 1, r = 25, data_size = 700_000;
		...
		writeHeader(wr_result, dataPath, k, r, pair.eps, pair.m, data_size);
		writeHeader(wr_time, dataPath, k, r, pair.eps, pair.m, data_size);
