...
public class MS_n {
	...
	private static double[][] readDataFile(String filePath, int data_size) throws IOException {
	...
	private static int[] readWorkload(String filePath, int data_size) throws IOException {
